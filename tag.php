...
?>
    ...
    <div class="container">
        ...
        <div class="tag-profile">
            <div class="tag-name"><?php single_term_title(); ?></div>
            <div class="tag-meta">
            ...
            <?php if ( '' != get_the_archive_description() ) : ?>
                <div class="tag-description"><?php echo wp_kses_post( get_the_archive_description() ); ?></div>
            <?php endif; ?>
        </div>

        <?php if ( have_posts() ) : ?>
            <div class="status-bar">
                <span>[REGISTROS DA TAG]</span>
        ...
        <?php else : ?>
            <div class="status-bar"><span>[STATUS: TAG VAZIA]</span><span>0 ENTRADAS</span></div>
