...
?>
    ...
    <div class="container">
        ...
        <div class="breadcrumb">
            ...
            <span>[BLOG_TATICO]</span>
        </div>

        <h1>Blog Tático</h1>

        <div class="status-bar">
            <span>[REGISTROS TEXTUAIS]</span>
            <span><?php echo wp_count_posts()->publish; ?> ENTRADAS</span>
        </div>
        ...
        <?php else : ?>
            <div class="no-posts">
                [AVISO] Nenhum registro encontrado no arquivo.<br>
                Status: VAZIO
            </div>
        <?php endif; ?>
